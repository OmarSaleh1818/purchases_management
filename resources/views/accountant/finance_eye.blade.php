...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">المدير العام</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ عرض طلب اصدار دفعة</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
...
@section('content')
    ...
    <form method="post" action="{{ route('financeye.update', $payment->id) }}">
        @csrf
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="number_order" value="{{$payment->number_order}}" readonly>
                    @error('number_order')
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" name="date" value="{{ $payment->date }}" readonly>
                    @error('date')
                    <span class="text-danger"> {{ $message }}</span>
                    @enderror
                </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="gentlemen" value="{{ $payment->gentlemen }}" readonly>
                    @error('gentlemen')
                    <span class="text-danger"> {{ $message }}</span>
                    @enderror
                </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="supplier_name" value="{{ $payment->supplier_name }}" readonly>
                    @error('supplier_name')
                    <span class="text-danger"> {{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="price" value="{{ $payment->price }}" readonly>
                    @error('price')
                    <span class="text-danger"> {{ $message }}</span>
                    @enderror
                </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="price_name" value="{{ $payment->price_name }}" readonly>
                    @error('price_name')
                    <span class="text-danger"> {{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" name="due_date" value="{{ $payment->due_date }}" readonly>
                    @error('due_date')
                    <span class="text-danger"> {{ $message }}</span>
                    @enderror
                </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="bank_name" value="{{ $payment->bank_name }}" readonly>
                    @error('bank_name')
                    <span class="text-danger"> {{ $message }}</span>
                    @enderror
                </div>
