...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">الادارة المالية</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ تعديل سند صرف</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
...
@section('content')
    ...
    <form method="post" action="{{ route('finance.receipt.update', $receipt->id) }}">
        @csrf
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="just" value="{{ $receipt->just }}" placeholder="فقط..." readonly>
                    @error('just')
                    <span class="text-danger"> {{ $message }}</span>
                    @enderror
                </div>
